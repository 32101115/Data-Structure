...
public class Test1 {
    ...
    private static final boolean TRY_REALLY_HARD_TO_GUESS_YOUR_INTENT = false;
    ...
    public void queue() {
        ...
        try {
            ...
            if (TRY_REALLY_HARD_TO_GUESS_YOUR_INTENT && e.getMessage().matches("(?i:.*heap.*)") && !e.getMessage().matches("(?i:.*backing heap*.)")) {
